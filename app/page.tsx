      ...
      <AnimatedSection className="container mx-auto px-4 py-16 bg-white/50 rounded-3xl mx-4 mb-16 relative">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <CarouselPrevious className="static translate-y-0 bg-white hover:bg-gray-100 border-2 border-gray-200" />
            <CarouselNext className="static translate-y-0 bg-white hover:bg-gray-100 border-2 border-gray-200" />
          </div>
        </Carousel>
      </AnimatedSection>
