...
import { Plus, Trash2, Shuffle, Users, Trophy, ArrowRight, ArrowLeft, Check, Pencil } from "lucide-react"
import { FaUsersRectangle } from "react-icons/fa6"
import { Swords } from "lucide-react" // Import Swords here
        ...
        <Card className="border-2 border-indigo-200">
          <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-t-lg">
            <CardTitle className="flex items-center gap-3 text-2xl">
              <FaUsersRectangle className="w-8 h-8" />
              Team-Generator
            </CardTitle>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            {!tournamentStarted ? (
              <>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                    {players.map((player, index) => (
                      <div key={index} className="flex items-center gap-1 bg-gray-100 rounded-lg p-2">
                        ...
                        />
                        <button onClick={() => removePlayer(index)} className="text-gray-400 hover:text-red-500 p-1">
                ...
                {/* Team-Anzahl */}
                <div className="space-y-3">
                  <Label className="text-lg font-semibold">Anzahl Teams</Label>
                ...
                <div className="flex items-center space-x-3 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">Teams treten über mehrere Runden gegeneinander an</p>
                  </div>
                </div>

                {teamsVsTeamsMode && (
                  <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
                    <Label className="font-semibold">Anzahl Spieltage</Label>
                    <Select
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {teams.map((team, index) => (
                          ...
                          >
                            <div
                              className={`${teamColors[index]?.bg || "bg-gray-500"} text-white px-4 py-2 font-bold flex items-center justify-between`}
                            >
                        ...
                        {teamsVsTeamsMode ? (
                          ...
                          <>
                            <Button
                              ...
                              className="w-full sm:w-auto bg-gradient-to-r from-teal-500 to-green-500 hover:from-teal-600 hover:to-green-600"
                            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-bold flex items-center gap-2">
                    ...
                    Spieltag {currentRoundIndex + 1} von {tournamentRounds.length}
                  </h3>
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <span className="font-semibold">Spieltag {currentRoundIndex + 1}</span>
                  <Button
                    onClick={nextRound}
                      ...
                      {match.team2Index === -1 ? (
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex-1 text-center">
                            <div className={`font-bold ${teamColors[match.team1Index]?.text}`}>
                              {getTeamName(match.team1Index)}
                            </div>
                          ...
                          {/* Team 2 */}
                          <div className="flex-1 text-center">
                            <div className={`font-bold ${teamColors[match.team2Index]?.text}`}>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b-2 border-gray-200">
                          ...
                          <th className="text-center py-2 px-3 font-bold">Punkte</th>
                        </tr>
                      </thead>
                      <tbody>
                        {getRankings().map((team, rank) => (
                          ...
                          >
                            ...
                            <td className={`py-2 px-3 font-semibold ${teamColors[team.colorIndex]?.text}`}>
                              {team.name}
                            </td>
                            <td className="text-center py-2 px-3 font-bold text-lg">{team.points}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                {isTournamentComplete() && (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold mb-2">Turnier beendet!</h3>
                    <p className="text-lg">
                      Gewinner:{" "}
                    ...
                    <p className="text-gray-600 mt-1">mit {getRankings()[0].points} Punkten</p>
                  </motion.div>
                )}
              </div>
            )}
