    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-6">
          <div className="flex items-center justify-center gap-4 mb-3">
            <motion.div
              ...
              className="w-14 h-14 sm:w-16 sm:h-16 bg-red-500 rounded-full flex items-center justify-center shadow-lg"
            >
        ...
        <Card className="max-w-2xl mx-auto border-2 border-gray-200">
          <CardHeader className="border-b bg-gradient-to-r from-red-50 to-red-100 py-3">
          ...
          <CardContent className="p-6 space-y-6">
            <div className="flex items-center justify-center gap-3">
              <div className="flex flex-col items-start gap-1">
                <label className="text-xs font-medium text-gray-600">Anzahl Würfel</label>
                <Select value={diceCount.toString()} onValueChange={(v) => setDiceCount(Number(v))}>
              ...
              <div className="flex flex-col items-start gap-1">
                <label className="text-xs font-medium text-gray-600">Würfeltyp</label>
                <Select
                  value={diceType.toString()}
                  onValueChange={(v) => {
                    setDiceType(Number(v))
            ...
            <div className="relative">
              <div className="flex flex-wrap justify-center gap-4 min-h-[160px] items-center py-6 bg-gradient-to-b from-gray-100 to-gray-50 rounded-xl border-2 border-gray-200">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setIsExpanded(true)}
                  className="absolute top-2 right-2 h-8 w-8 p-0 text-gray-400 hover:text-gray-600 hover:bg-gray-100 z-10"
                  title="Vollbild"
                >
            ...
            {results.length > 0 && !isRolling && (
              <div className="text-center py-4 bg-gradient-to-r from-red-50 to-red-100 rounded-xl border-2 border-red-200">
                <p className="text-sm text-gray-600 mb-2 font-semibold">Wurfergebnis</p>
            ...
            {history.length > 0 && (
              <div className="border-t-2 pt-4">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-gray-700 font-bold text-base">Verlauf</h4>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setHistory([])}
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {history.map((h, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center text-gray-700 bg-gray-50 hover:bg-gray-100 px-4 py-2 rounded-lg border border-gray-200 transition-colors"
                    >
                      <span className="text-sm">
                        {h.dice.join(" + ")} <span className="text-gray-500">(D{h.type})</span>
                      </span>
