    ...
    return (
      <div className="fixed inset-0 z-50 bg-gradient-to-b from-gray-900 to-gray-800 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-8 p-4">
          <div className="text-center py-12 px-16 rounded-3xl bg-white/10 min-w-[300px]">
            <AnimatePresence mode="wait">
              {currentWord ? (
                <motion.div
                  ...
                  className={`text-6xl font-bold ${isGenerating ? "text-gray-500" : "text-pink-400"}`}
                >
                  {currentWord}
                </motion.div>
              ) : (
        ...
        <Card className="max-w-2xl mx-auto border-2 border-gray-200">
          ...
          <CardContent className="p-4 space-y-4">
            ...
            <div className="relative">
              ...
              <div className="bg-gray-50 rounded-xl p-6 text-center min-h-[140px] flex items-center justify-center border-2 border-gray-200">
                <AnimatePresence mode="wait">
                  {currentWord ? (
                    <motion.div
                      key={currentWord}
