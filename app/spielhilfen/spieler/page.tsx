          ...
          <CardContent className="p-6 space-y-6">
            ...
            {gameStarted && (
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 text-center">
                ...
                <p className="text-2xl font-bold text-green-700 mb-3">{players[currentPlayerIndex]?.name}</p>
                <div className="flex justify-center gap-2">
                  ...
                  <Button onClick={nextTurn} className="bg-green-500 hover:bg-green-600">
                    Nächster <ChevronRight className="w-4 h-4" />
                  </Button>
                </div>
              </div>
            )}
            ...
            {!gameStarted && (
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button onClick={addPlayer} disabled={players.length >= 10} className="bg-green-500 hover:bg-green-600">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {!gameStarted ? (
                ...
                <Button onClick={resetGame} variant="outline" className="text-red-500 hover:bg-red-50 bg-transparent">
