        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <span className="text-orange-600 font-bold transform rotate-1 font-handwritten">Marktplatz</span>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div key={i} className={`bg-white rounded-lg p-4 shadow-lg border-2 border-gray-200 animate-pulse transform ${i % 2 === 0 ? 'rotate-1' : '-rotate-1'}`}>
