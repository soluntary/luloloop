...
const games = [
  ...
  },
  {
    ...
    title: "2048",
    description:
      "Schaffst du die 2048? Bilde eine Kachel mit der Zahl 2048 durch geschicktes Verschieben und Kombinieren anderer Kacheln! Ein süchtig machendes Puzzle-Spiel.",
    icon: null,
    color: "purple",
    rotation: "rotate-1",
    linkText: "Spielen",
