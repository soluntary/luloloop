        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <Card className="transform -rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Voraussetzungen:</h4>
                ...
                <h4 className="font-semibold text-sm text-gray-800">Deine Pflichten:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Erlaubte Nutzung:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Verbotene Aktivitäten:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform -rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Wichtige Hinweise:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Unsere Rolle:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Deine Inhalte:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Unsere Inhalte:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform -rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Community-Standards:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Sicherheitsmaßnahmen:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Unsere Haftung:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform -rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              ...
              <CardContent className="font-body text-xs text-gray-600 space-y-4">
                <h4 className="font-semibold text-sm text-gray-800">Deine Kündigung:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <h4 className="font-semibold text-sm text-gray-800">Sperrung durch uns:</h4>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <Card className="transform rotate-1 hover:rotate-0 transition-all border-2 border-gray-200">
              <CardContent className="p-8">
                ...
                <div className="font-body text-xs text-gray-600 space-y-4">
                  <p>
